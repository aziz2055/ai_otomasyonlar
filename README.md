    ...
    <script>
        window.ChatWidgetConfig = {
            ...
            branding: {
                ...
                name: 'aziz efe',
                welcomeText: 'Sorularınıza anında cevap alın!',
                responseTimeText: 'Sohbete başlamak için aşağıdaki butona tıklayın'
            },
            style: {
                primaryColor: '#10b981',
            ...
            suggestedQuestions: [
                ...
                'Ürünler hakkında bilgi verebilir misiniz?',
        ...
        (function() {
            ...
            const defaultSettings = {
                ...
                branding: {
                    ...
                    responseTimeText: '',
                    poweredBy: {
                        text: 'n8n tarafından destekleniyor',
            ...
            const welcomeScreenHTML = `
                ...
                <div class="user-registration">
                    <h2 class="registration-title">Sohbete başlamak için bilgilerinizi girin</h2>
                    <form class="registration-form">
                        <div class="form-field">
                            <label class="form-label" for="chat-user-name">İsim</label>
                            <input type="text" id="chat-user-name" class="form-input" placeholder="Adınız" required>
                            <div class="error-text" id="name-error"></div>
                        </div>
                        <button type="submit" class="submit-registration">Sohbete Devam Et</button>
                    </form>
                </div>
            `;

            // Create chat interface without duplicating the header and without footer
            const chatInterfaceHTML = `
                <div class="chat-body">
                    <div class="chat-messages"></div>
                    <div class="chat-controls">
                        <textarea class="chat-textarea" placeholder="Mesajınızı buraya yazın..." rows="1"></textarea>
            ...
            async function handleRegistration(event) {
                ...
                const sessionData = [{
                    ...
                    metadata: {
                        userId: name, // Email kaldırıldığı için userId olarak name kullanıyoruz
                        userName: name
                    }
                }];
                ...
                try {
                    ...
                    const userInfoMessage = `İsim: ${name}`;
                    ...
                    errorMessage.textContent = "Sunucuya bağlanılamadı. Lütfen daha sonra tekrar deneyin.";
            ...
            async function submitMessage(messageText) {
                ...
                try {
                    ...
                    const errorMessage = document.createElement('div');
                    errorMessage.className = 'chat-bubble bot-bubble';
                    errorMessage.textContent = "Mesajınız gönderilemedi. Lütfen tekrar deneyin.";
                    messagesContainer.appendChild(errorMessage);
                    messagesContainer.scrollTop = messagesContainer.scrollHeight;
                } finally {
...
<body>
    <!-- Chat widget otomatik olarak eklenecek -->
</body>
</html>
